...
//    인텐트에서 상대방 장비의 주소를 넘겨줄때 쓰는 메모
    ...
    private android.widget.ListView newDeiviceListView;
    private android.widget.ListView pairedDeiviceListView;

//    처음 연결하는 기기들을 보여주기 위한 리스트 / 어댑터
...
//                TODO - 다음화면 진행 필요
        ...
        newDeiviceListView.setOnItemClickListener(deviceClickListener);
        pairedDeiviceListView.setOnItemClickListener(deviceClickListener);
...
//        1. 새 기기 목록 리스트뷰를 표시, 페어링 된 목록 리스트 숨김.
        ...
        newDeiviceListView.setVisibility(View.VISIBLE);
        pairedDeiviceListView.setVisibility(View.GONE);
...
//        기존에 페어링 된 기기를 보여줄 리스트뷰 세팅
        ...
        pairedDeiviceListView.setAdapter(pairedDeviceAdapter);
...
//            페어링 목록을 보여주고, 새 기기 목록을 숨겨주자.
            newDeiviceListView.setVisibility(View.GONE);
            pairedDeiviceListView.setVisibility(View.VISIBLE);

//            페어링된 기기 목록을 리스트에 추가하고, 데이터 새로 고침
...
//        탐색된 블루투스 기기를 보여줄 리스트뷰 세팅
        ...
        newDeiviceListView.setAdapter(mBtListAdapter);
...
//        수신하고 싶은 방송을 등록
//        재료 2가지
//        1) 방송이 수신되었을때 진행할 행동을 담은 Receiver => 맨 밑에 따로 작성
...
//            1. 기기 탐색(Discovering) 결과 어떤 기기를 발견했을때
...
//                     다시 탐색할 수 있도록 버튼 표시
    ...
    public void bindViews() {
        this.pairedDeiviceListView = (ListView) findViewById(R.id.pairedDeiviceListView);
        this.newDeiviceListView = (ListView) findViewById(R.id.newDeiviceListView);
