...
public class BluetoothChatServiceEX {
...
//    채팅 화면에 연결상태 등등을 전달 하기 위한 매체
    private Handler mHandler;
//    접속을 수락하는데 사용되는 쓰레드
//    접속을 수락 => 누군가 원격에서 나에게 채팅을 요청하면 받아들이는 기능.
    private AcceptThread mAcceptThread;
//    연결을 시도하는 역할을 전담하는 쓰레드
    private ConnectThread mConnectThread;
//    연결이 되어있을때 통신 (메세지 주고 받기) 전담하는 쓰레드
...
//    4가지 상태값들.
    ...
    public BluetoothChatServiceEX(Context context, Handler handler){
//        블루투스 채팅이 시작될 때.
//        블루투스 기기 목록을 다루는 어댑터 받아오기.
        mBtAdapter = BluetoothAdapter.getDefaultAdapter();

//        아직 통신을 시작하기 않았으니, 상태값을 아무것도 안하고 있는것으로 기록.
